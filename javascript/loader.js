...
switch (collectionInfo.background.type) {
    ...
    case "image":
        ...
        const imageStyle = `<style> .body { background-image: url('images/%24%7bcollectionInfo.background.html'); background-repeat: no-repeat; background-size: cover; background-attachment: fixed; background-position: center } </style>`
